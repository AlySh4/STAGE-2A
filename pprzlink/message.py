            ...
            if len(s) > 1:  # this is an array
                ...
                for x in self.fieldvalues[idx]:
                    if bin_type[0] == 'f' or bin_type[0] == 'd':
                        data.append(float(x))
                    elif bin_type[0] == 'B' or bin_type[0] == 'H' or bin_type[0] == 'L' or bin_type[0] == 'b' or \
                            bin_type[0] == 'h' or bin_type[0] == 'l':
                        data.append(int(x))
                    elif bin_type[0] == 'c':
                ...
                elif bin_type[0] == 'B' or bin_type[0] == 'H' or bin_type[0] == 'L' or bin_type[0] == 'b' or bin_type[
                    0] == 'h' or bin_type[0] == 'l':
